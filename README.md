...
[travis-badge]: https://travis-ci.org/filipesilva/angular-circle-component.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-circle-component
...
1. Create a project folder (you can call it `circle-component` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-circle-component.git
cd angular-circle-component
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-circle-component/archive/master.zip)
...
Use your editor to search the project for all instances of `circle-component` and change it
